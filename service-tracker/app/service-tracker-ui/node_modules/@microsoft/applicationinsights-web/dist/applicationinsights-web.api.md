...
//
// types/Initialization.d.ts:49:5 - (ae-forgotten-export) The symbol "Data" needs to be exported by the entry point applicationinsights-web.d.ts
// types/Initialization.d.ts:50:5 - (ae-forgotten-export) The symbol "Base" needs to be exported by the entry point applicationinsights-web.d.ts
// types/Initialization.d.ts:51:5 - (ae-forgotten-export) The symbol "Envelope" needs to be exported by the entry point applicationinsights-web.d.ts
// types/Initialization.d.ts:60:5 - (ae-forgotten-export) The symbol "Data" needs to be exported by the entry point applicationinsights-web.d.ts
// types/Initialization.d.ts:62:5 - (ae-forgotten-export) The symbol "ConfigurationManager" needs to be exported by the entry point applicationinsights-web.d.ts
// types/Initialization.d.ts:63:5 - (ae-forgotten-export) The symbol "ContextTagKeys" needs to be exported by the entry point applicationinsights-web.d.ts
// types/Initialization.d.ts:64:5 - (ae-forgotten-export) The symbol "DataSanitizer" needs to be exported by the entry point applicationinsights-web.d.ts
// types/Initialization.d.ts:65:5 - (ae-forgotten-export) The symbol "TelemetryItemCreator" needs to be exported by the entry point applicationinsights-web.d.ts
